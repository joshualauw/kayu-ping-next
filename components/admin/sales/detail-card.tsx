      ...
      <Card className="w-full">
        ...
        <CardContent className="space-y-8">
              ...
              <div className="flex justify-end border-t pt-4">
                <div className="flex gap-8 text-right">
                  <div>
                    ...
                    <span className="text-sm font-bold text-primary">{sale.totalVolume.toFixed(4)} m³</span>
                  </div>
                  <div>
                    <span className="block text-[10px] font-semibold tracking-wider text-muted-foreground uppercase">Total Price</span>
                    <span className="text-sm font-bold text-primary">{formatCurrency(sale.totalPrice)}</span>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <FeeTable
            ...
            referenceType="SALES"
            fees={sale.fees}
            totalPriceAfterFee={sale.totalPriceAfterFee}
          />

          <div className="mt-6 flex items-center justify-end gap-3 border-t pt-4">
            <Button type="button" variant="secondary" size="sm" onClick={() => router.push("/admin/sales")} className="flex items-center gap-2">
