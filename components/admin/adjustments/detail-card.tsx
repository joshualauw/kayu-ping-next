      ...
      <Card className="w-full">
        ...
        <CardContent className="space-y-8">
          ...
          <FeeTable
            ...
            totalPriceAfterFee={adjustment.totalPriceAfterFee}
          />

          <div className="mt-6 flex items-center justify-end gap-3 border-t pt-4">
            <Button type="button" variant="secondary" size="sm" onClick={() => router.push("/admin/adjustments")} className="flex items-center gap-2">
